...
# Buat database
sqlite3 panel/database.db <<EOF
CREATE TABLE IF NOT EXISTS member (                                                       id INTEGER PRIMARY KEY,
  username TEXT,
  password TEXT,
  saldo REAL DEFAULT 0
);
...
INSERT OR IGNORE INTO member (id, username, password, saldo) VALUES (1, 'admin', 'passw>
INSERT OR IGNORE INTO layanan (id, nama, harga) VALUES (1, 'Layanan 1', 1000);
INSERT OR IGNORE INTO layanan (id, nama, harga) VALUES (2, 'Layanan 2', 2000);
EOF
